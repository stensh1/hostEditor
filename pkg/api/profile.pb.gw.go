...
var (
	filter_Editor_Remove_0 = &utilities.DoubleArray{Encoding: map[string]int{"dns_server": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_Editor_Remove_0(ctx context.Context, marshaler runtime.Marshaler, client EditorClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Editor_Remove_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	filter_Editor_Auth_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_Editor_Auth_0(ctx context.Context, marshaler runtime.Marshaler, client EditorClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Editor_Auth_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_Editor_Auth_0(ctx context.Context, marshaler runtime.Marshaler, server EditorServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AuthRequest
	var metadata runtime.ServerMetadata
...
func RegisterEditorHandlerServer(ctx context.Context, mux *runtime.ServeMux, server EditorServer) error {
	...
	mux.Handle("PATCH", pattern_Editor_SetName_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/api.Editor/SetName", runtime.WithHTTPPathPattern("/set_hostname"))
		if err != nil {
	...
	mux.Handle("POST", pattern_Editor_Add_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/api.Editor/Add", runtime.WithHTTPPathPattern("/add_dns"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_Editor_Auth_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/api.Editor/Auth", runtime.WithHTTPPathPattern("/api/session"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Editor_Auth_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Editor_Auth_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterEditorHandlerClient(ctx context.Context, mux *runtime.ServeMux, client EditorClient) error {
	...
	mux.Handle("PATCH", pattern_Editor_SetName_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/api.Editor/SetName", runtime.WithHTTPPathPattern("/set_hostname"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_Editor_Add_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/api.Editor/Add", runtime.WithHTTPPathPattern("/add_dns"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_Editor_Auth_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/api.Editor/Auth", runtime.WithHTTPPathPattern("/api/session"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Editor_Auth_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Editor_SetName_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"set_hostname"}, ""))

	pattern_Editor_GetName_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"hostname"}, ""))

	pattern_Editor_Add_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"add_dns"}, ""))
	...
	pattern_Editor_Auth_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "session"}, ""))
)
...
var (
	...
	forward_Editor_Auth_0 = runtime.ForwardResponseMessage
)
